...
public class Silver extends Salon {
    ...
    public Silver(int pilihan, int pilProduk[], int pilJasa[]) {
    ...
    public int diskon() {
        ...
        if (super.pilihan == 1) {
            ...
            System.out.println("-------------------------------------------------------------");
            System.out.println("Selamat!, anda mendapatkan diskon Silver 10%!");
            System.out.println("-------------------------------------------------------------");
            ...
            totalbiaya = totalbiaya * 90 / 100;
            System.out.println("-------------------------------------------------------------");
            System.out.println("Selamat!, anda mendapatkan diskon Silver 10% dan Anggota 10%!");
            System.out.println("-------------------------------------------------------------");
            System.out.printf("Total Yang Harus Dibayar: " + "\t%s", " : Rp. " + totalbiaya + "\n");
            System.out.println("-------------------------------------------------------------");
            System.out.println("");
